...
export default function Home() {
  ...
  return (
    <main className="min-h-screen">
      ...
      <section
        id="home"
        className="relative min-h-[90vh] flex items-center pt-32 md:pt-48 pb-20 overflow-hidden bg-white"
      >
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-7xl font-extrabold leading-[1.1] mb-6 text-slate-900 tracking-tight">
              Innovating for a <br />
              <span className="text-emerald-600">Healthier Tomorrow</span>
            </h1>
            <p className="text-lg md:text-xl text-slate-600 mb-10 text-pretty leading-relaxed max-w-2xl font-medium">
            ...
            <div className="flex flex-wrap gap-4">
              <Button
                ...
                className="bg-emerald-600 hover:bg-emerald-700 text-white px-8 py-6 text-lg rounded-full shadow-lg transition-all"
              >
                Our Portfolio
              </Button>
              <Button
                ...
                className="text-slate-900 border-slate-300 hover:bg-slate-100 px-8 py-6 text-lg rounded-full transition-all bg-white"
              >
                Learn More
              </Button>
            </div>
        ...
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="relative">
              ...
              />
              <div className="absolute -bottom-8 -right-8 bg-primary text-white p-8 rounded-2xl hidden md:block">
              ...
              <div className="grid sm:grid-cols-2 gap-6 mb-8">
                {[
                  ...
                  <div key={i} className="flex gap-4 p-4 rounded-xl border bg-slate-50">
                    <item.icon className="w-8 h-8 text-emerald-600 shrink-0" />
                    <div>
      ...
      <section id="quality" className="py-24 bg-slate-900 text-white overflow-hidden relative">
        <div className="absolute top-0 right-0 w-1/3 h-full bg-emerald-500/10 skew-x-12 transform translate-x-20" />
        <div className="container mx-auto px-6 relative z-10">
          <div className="grid md:grid-cols-2 gap-12">
            <div className="p-10 rounded-3xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-emerald-500/50 transition-colors group">
              <div className="w-16 h-16 bg-emerald-500 rounded-2xl flex items-center justify-center mb-8 group-hover:scale-110 transition-transform">
            ...
            <div className="p-10 rounded-3xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-emerald-500/50 transition-colors group">
              <div className="w-16 h-16 bg-emerald-400 rounded-2xl flex items-center justify-center mb-8 group-hover:scale-110 transition-transform">
      ...
      <section className="py-24 bg-emerald-50 border-t border-emerald-200">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-4xl font-bold text-slate-900 mb-4">Complete Product Catalog</h2>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-12 space-y-6">
              ...
              <Button asChild className="bg-emerald-600 hover:bg-emerald-700 text-white px-10 py-4 text-lg rounded-full shadow-lg inline-flex items-center gap-3 font-semibold transition-all">
      ...
      <section id="products" className="py-24 bg-gradient-to-b from-white to-slate-50">
        <div className="container mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <h2 className="text-4xl font-bold mb-4 text-slate-900">Our Comprehensive Product Range</h2>
              ...
              >
                <CardContent className="p-8">
                  <div className="flex items-start justify-between mb-6">
                    ...
                    <div className="bg-emerald-100 text-emerald-700 font-bold px-4 py-2 rounded-full text-lg shrink-0">
                      {category.count}
                    </div>
                  </div>
                  ...
                  <div className="grid sm:grid-cols-2 gap-4 mt-6">
                    {category.products.map((product, pidx) => (
                      <div
                        key={pidx}
                        className="p-3 bg-slate-50 rounded-lg border border-slate-200 hover:border-emerald-300 hover:bg-emerald-50 transition-all"
                      >
      ...
      <section className="py-24">
        <div className="container mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-muted-foreground">The pillars that define our commitment to medical excellence.</p>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <div className="space-y-8">
                  ...
                  <div className="grid gap-3">
                    ...
                    <div className="flex flex-col gap-2">
                      <a
                        ...
                        className="text-lg font-semibold text-emerald-600 hover:text-emerald-700 transition-colors flex items-center gap-2"
                      >
                        +91 8502004099
                      </a>
                      <Button
                        onClick={() => window.open("https://wa.me/918502004099", "_blank")}
                        className="bg-emerald-600 hover:bg-emerald-700 text-white w-full rounded-xl py-3 font-semibold transition-all"
                      >
                        Contact on WhatsApp
                      </Button>
                    </div>
                ...
                <div className="flex gap-6">
                  ...
                  <div className="grid gap-2">
                    <h5 className="font-bold mb-1">Email Contacts</h5>
                    <p className="text-sm">
              ...
              <div className="w-full h-[400px] bg-muted rounded-2xl overflow-hidden shadow-inner relative">
                <iframe
      ...
      {/* Footer */}
      <footer className="bg-slate-900 text-slate-100 pt-24 pb-12 border-t border-slate-800">
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-12 gap-16 pb-16 mb-12 border-b border-slate-700">
            <div className="md:col-span-4">
              <div className="inline-block mb-10 h-24 md:h-32">
                <img src="/logo.jpg" alt="Anahat Logo" className="h-full w-auto object-contain" />
              </div>
              <p className="text-slate-300 text-lg leading-relaxed mb-8 pr-10">
            ...
            <div className="md:col-span-2">
              <h6 className="font-bold text-xl mb-8 text-slate-100">Company</h6>
            ...
            <div className="md:col-span-2">
              <h6 className="font-bold text-xl mb-8 text-slate-100">Divisions</h6>
              <ul className="space-y-4 text-base text-slate-300">
